...
// @generated from protobuf file "discord_users/v1/PreloadedUserSettings.proto" (package "discord_protos.discord_users.v1", syntax proto3)
// tslint:disable
...
export interface PreloadedUserSettings_DefaultReactionEmoji {
    ...
    animated?: BoolValue;
    /**
     * @generated from protobuf field: optional google.protobuf.BoolValue disable_double_tap = 4
     */
    disableDoubleTap?: BoolValue;
}
/**
 ...
 */
export enum PreloadedUserSettings_CustomStatusPushNotificationType {
    /**
...
class PreloadedUserSettings_DefaultReactionEmoji$Type extends MessageType<PreloadedUserSettings_DefaultReactionEmoji> {
    constructor() {
        super("discord_protos.discord_users.v1.PreloadedUserSettings.DefaultReactionEmoji", [
            ...
            { no: 4, name: "disable_double_tap", kind: "message", T: () => BoolValue }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* optional google.protobuf.BoolValue disable_double_tap */ 4:
                    message.disableDoubleTap = BoolValue.internalBinaryRead(reader, reader.uint32(), options, message.disableDoubleTap);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: PreloadedUserSettings_DefaultReactionEmoji, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.disableDoubleTap)
            BoolValue.internalBinaryWrite(message.disableDoubleTap, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class PreloadedUserSettings_GuildFolders$Type extends MessageType<PreloadedUserSettings_GuildFolders> {
    constructor() {
        super("discord_protos.discord_users.v1.PreloadedUserSettings.GuildFolders", [
            { no: 1, name: "folders", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => PreloadedUserSettings_GuildFolder },
